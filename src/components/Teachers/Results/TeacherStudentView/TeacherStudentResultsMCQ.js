                                ...
                                {isCorrect ? (
                                    <div style={{ display: 'flex', paddingBottom: '30px', width: '100%' }}>
                                        <div style={{ 
                                            ...
                                            <h1 style={{ color: '#2BB514', fontSize: '28px', marginTop: '10px', fontFamily: '"montserrat", sans-serif', marginLeft: '20px' }}>
                                                Student Answer
                                            </h1>
                                        ...
                                        {hasExplanation && (
                                            <div style={{ width: '370px', marginLeft: '20px' }}>
                                                <h1 style={{ fontSize: '28px', marginTop: '0px', fontFamily: '"montserrat", sans-serif', color: 'black' }}>Explanation</h1>
                                    ...
                                    <div style={{paddingBottom: '30px', width: '100%'}}>
                                        <div style={{ display: 'flex', borderBottom: '4px solid lightgrey', paddingBottom: '30px' }}>
                                            <div style={{ 
                                                ...
                                                <h1 style={{ color: 'darkred', fontSize: '28px', marginTop: '10px', fontFamily: '"montserrat", sans-serif', marginLeft: '20px' }}>
                                                    Student Answer
                                                </h1>
                                            ...
                                            {hasExplanation && (
                                                <div style={{ width: '370px', marginLeft: '20px' }}>
                                                    <h1 style={{ fontSize: '28px', marginTop: '0px', fontFamily: '"montserrat", sans-serif', color: 'black' }}>
                                                        Explanation
                                                    </h1>
                                                    <p style={{ fontSize: '20px', color: 'grey' }}>{questionData.explanation}</p>
                                                </div>
        ...
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'white' }}>
            ...
            <div style={{ /* ... main div styles ... */ }}>
               ...
               <div style={{ display: 'flex', alignItems: 'center', marginBottom: '-40px', justifyContent: 'space-around' }}>
                    <h1 style={{ fontFamily: "'montserrat', sans-serif", fontSize: '40px', color: 'grey', width: '1000px', textAlign: 'center', marginTop: '100px' }}>
                        {assignmentName}
                        <h1 style={{ fontSize: '80px', color: 'black', fontFamily: "'montserrat', sans-serif",marginTop: '20px' }}> {studentName}</h1>
                    </h1>
                </div>
                <div style={{ marginBottom: '40px', fontFamily: "'montserrat', sans-serif", backgroundColor: 'white', display: 'flex', width: '1000px', height: '70px', marginLeft: 'auto', marginRight: 'auto', borderRadius: '100px',  border: '4px solid #F4F4F4', alignItems: 'center', justifyContent: 'space-around' }}>
                ...
                <div style={{ fontSize: '40px', fontWeight: 'bold', color: 'black' }}>
                    ...
                    <div style={{ width: '100px', height: '100px', border: '10px solid #627BFF', borderRadius: '20px', background: '#020CFF', marginTop: '0px', marginRight: '-85px', zIndex: '100' }}>
                        <div style={{ width: '79px', height: '79px', backgroundColor: 'white', borderRadius: '5px', margin: 'auto', marginTop: '10px', justifyContent: 'space-around', fontSize: '60px', alignItems: 'center', position: 'relative', fontFamily: "'montserrat', sans-serif" }}>
                            <h1 style={{ backgroundColor: 'transparent', borderRadius: '5px', marginTop: '11px', justifyContent: 'space-around', fontSize: '60px', textAlign: 'center', alignItems: 'center', position: 'relative', fontFamily: "'montserrat', sans-serif" }}>
                ...
                <div style={{ fontFamily: "'montserrat', sans-serif", background: '#f4f4f4', padding: '15px', borderRadius: '10px', height: '50px', width: '220px', borderTopRightRadius: '100px', borderBottomRightRadius: '100px', marginRight: '-50px',marginBottom: '0px', color: 'grey', fontSize: '20px', fontWeight: 'bold' }}>
