    ...
    return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'white' }}>
            ...
            <div style={{ display: 'flex',marginTop: '70px', alignItems: 'center', marginBottom: '-10px', justifyContent: 'space-around' }}>
                ...
                <div style={{ marginBottom: '40px', fontFamily: "'montserrat', sans-serif", backgroundColor: 'white', display: 'flex', width: '900px', height: '70px', marginLeft: 'auto', marginRight: 'auto', borderRadius: '15px',  border: '4px solid #F4F4F4', alignItems: 'center',}}>
        ...
        position: 'relative'
               ...
               <div style={{position: 'relative', height: '90px'}}>
                <p style={{ fontFamily: "'montserrat', sans-serif", fontSize:'20px', fontWeight: 'bold', marginBottom: '60px', color: 'grey', position:'absolute', left: '40px',top: '-10px'   }}> Completed: {new Date(results.submittedAt.toDate()).toLocaleString()}</p>
