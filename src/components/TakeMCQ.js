...
>
 <h1 style={{fontSize: '60px', fontFamily:' "rajdhani", sans-serif'}}>{assignmentName}</h1>
</header>
 ...
 {questions.length > 0 && (
        <div style={{ width: '1000px', marginLeft: 'auto', marginRight: 'auto', marginTop: '150px', position: 'relative' }}>
          <div style={{
            ...
            marginLeft: 'auto', marginRight: 'auto', marginTop: '0px', fontFamily: "'Radio Canada', sans-serif", userSelect: 'none'
          }}>
